    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 sm:p-6">
      <div className="w-full max-w-md">
        <div className="flex items-center gap-3 mb-6">
          <div>
            <p className="text-xs text-slate-500 leading-none">ADA University</p>
            <p className="text-2xl font-semibold text-slate-900 leading-tight">Attendance</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className="p-6 sm:p-7">
            <h1 className="text-lg font-semibold text-slate-900 mb-1">Create Attendance Session</h1>
            <p className="text-sm text-slate-500 mb-6">Set up a QR code for your class to scan.</p>
            ...
            {result && (
              <div className="mt-5 rounded-lg border border-ada-blue/20 bg-ada-blue-light px-4 py-4">
                <p className="text-sm font-semibold text-slate-900 mb-1">Session created</p>
                <p className="text-sm text-slate-600 mb-2">
                  Open this link on the classroom screen. Keep it private — it controls the session.
                </p>
